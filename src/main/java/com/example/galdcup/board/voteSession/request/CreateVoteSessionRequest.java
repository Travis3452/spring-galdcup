package com.example.galdcup.board.voteSession.request;

import com.example.galdcup.board.vote.request.VoteOptionRequest;
...
public record CreateVoteSessionRequest(
        ...
        @Size(max = 1000, message = "투표 설명은 1000자를 초과할 수 없습니다.")
        String description,
